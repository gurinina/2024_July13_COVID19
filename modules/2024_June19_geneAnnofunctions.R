...
p10 <- function(matI,x,sig = 1,ylab1 = "fitness defect",
       xlab1 = "gene",las1 = 2,font1 = 4,cex1 = 1.5,pch1 = 17,
       cex.main1 = 1.5,cex.axis1 = 1.2,cex.lab1=1.2,cex.text1 = 1,...)  {
...
href="https://www.yeastgenome.org/locus/"

if(sgdlink) {
  dmat$GENE = myhyperlinkblank(x = fdat$sgd_gene[m],href = href)
}


if(sgdlink) {
  dmat = dmat[,c("FD","ORF","gene","GENE","descriptor")]
}
