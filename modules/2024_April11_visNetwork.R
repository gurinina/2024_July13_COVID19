...
###### 940 pixels = 12 columns; 9.792 inches/940 pixels = 0.0104 inches/pixel
###### 940/9.792 = 96 pixels/inch; 940/12 = 78.333 pixels/column;
###### 78.333*3 = 235 pixels/3 columns; 235/96 = 2.45 inches/3 columns
###### 235 characters/3 column
...
width = 3,
box(
title = "Selected input datasets:",
br(),
prettyRadioButtons(ns("site"),
label = NULL, choices =
c(
...
outline = T, fill = F, thick = T,
status = "primary", shape = "square", bigger = F,
selected = "marjhop", inline = F
),
...
width = 3,
box(
title = "Reset menu:", align = "center",
br(),
actionButton(ns("resetGO"), label = "reset cmpMenu"),
solidHeader = TRUE, width = "100%", height = 170, status = "primary"
) # box
),
column(
width = 5,
box(
title = "Fitness threshold:", # input score threshold = 3 ~ P < 0.001
sliderInput(ns("scorethreshMOD"),
...
box(
title = "FDR threshold:",
sliderInput(ns("fdrMOD"),
label = "(FDR default = 0.2)", min = 0, max = 0.5,
...
fluidRow(
box(
title = "GoSet Enrichment Table:", DT::dataTableOutput(ns("enrichTable")),
status = "primary", solidHeader = TRUE, width = 12
)
),
fluidRow(
box(
title = "GO term enrichment table:",
column(
width = 12, align = "center",
br(),
...
updateSliderInput(session, "fdrMOD",
label = NULL,
...
c(
"2008 Erikson PLOS Genetics" = "elke",
"2021 HIPHOP Marjan only" = "marjhiphop",
...
selected <- "23May09:doxorubicin-hydrochloride_13uM"
} else if (site == "elke") {
...
network <- runGOENRICH(
fdrThresh = FDR, curr_exp = curr_exp, score = df,
bp_path = "2023_January30_GOBP.RDS", go_path = "2023_January30_GOID_GOBP_SGD.txt"
)
...
out <- out[, c(
"GOID", "term", "querySetFraction", "geneSetFraction",
